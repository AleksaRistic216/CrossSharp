...
public class HighContrastTheme : ITheme
{
    ...
    public virtual ColorRgba SecondaryColor { get; set; } = ColorRgba.White;
    public virtual int DefaultCornerRadius { get; set; } = Constants.DEFAULT_CONTAINED_CORNER_RADIUS;
    public virtual int DefaultLayoutItemSpacing { get; set; } = Constants.DEFAULT_CONTAINED_LAYOUT_ITEM_SPACING;
}
