...
public class RoundedSpacedDarkTheme : ThemeBase
{
    ...
    public override ColorRgba PrimaryColor { get; set; } = ColorRgba.DarkGray;
    public override ColorRgba SecondaryColor { get; set; } = ColorRgba.DimGray;
